...
def create_full_transit_data():
    ...
    td.stops.add(stop_id=10001, stop_name="Platform 1", stop_lat=31.789467, stop_lon=35.203715,
    ...
    td.shapes.add(shape_id=1, shape_pt_lat=td.stops[10001].stop_lat, shape_pt_lon=td.stops[10001].stop_lon,
                  shape_pt_sequence=0, shape_dist_traveled=0)
    td.shapes.add(shape_id=1, shape_pt_lat=td.stops[20000].stop_lat, shape_pt_lon=td.stops[20000].stop_lon,
                  shape_pt_sequence=1, shape_dist_traveled=None, test_attribute="shape test data")
    td.shapes.add(shape_id=2, shape_pt_lat=td.stops[20000].stop_lat, shape_pt_lon=td.stops[20000].stop_lon,
                  shape_pt_sequence=0)
    td.shapes.add(shape_id=2, shape_pt_lat=td.stops[10001].stop_lat, shape_pt_lon=td.stops[10001].stop_lon,
                  shape_pt_sequence=1)
    ...
    td.agencies.add(agency_id=15, agency_name="agency name 15", agency_url="https://www.agencyname15.com/",
    ...
    td.trips.add(trip_id="1001_1", route_id="1001", service_id=2, shape_id=1, bikes_allowed=False)
    td.trips.add(trip_id="1001_2", route_id="1001", service_id=1, shape_id=2, bikes_allowed=None)
    ...
    td.trips.add(trip_id="1003_1", route_id="1003", service_id=1, wheelchair_accessible=False)
    td.trips.add(trip_id="30001_1", route_id="30001", service_id=2, trip_headsign="trip headsign",
    ...
    td.fare_attributes.add(fare_id="3", price=16.85, currency_type="ILS", payment_method=1, transfers=0, agency_id=15,
    ...
    td.fare_rules.add(fare_id="2", route_id="1003", test_attribute="fare rule test data")

...
GTFS_SAMPLE_FILE_WITH_BOM = os.path.join(RESOURCES_DIR_PATH, "sample_gtfs_with_bom.zip")
GTFS_TEST_FILES = [GTFS_SAMPLE_FILE, GTFS_MINI_REAL_FILE, GTFS_SAMPLE_FILE_WITH_BOM]
